...
namespace WorkerBookingSystem.Migrations
{
    ...
    [Migration("20260827152344_AddWorkerPayoutAndAdminFunds")]
    partial class AddWorkerPayoutAndAdminFunds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkerBookingSystem.Models.AdminFundTransaction", b =>
                {
                    b.Property<int>("AdminFundTransactionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdminFundTransactionId"));
                    ...
                    b.HasKey("AdminFundTransactionId");
                    ...
                    b.ToTable("AdminFundTransactions");
                });
            ...
            modelBuilder.Entity("WorkerBookingSystem.Models.Booking", b =>
                {
                    ...
                    b.Property<decimal>("CompanyFundAdvanceAmount")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.Property<DateTime?>("WorkerPaidDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("WorkerPayoutMethod")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WorkerPayoutReference")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WorkerBookingSystem.Models.UpiPaymentSubmission", b =>
                {
                    ...
                    b.ToTable("UpiPaymentSubmissions");
                });
            ...
            modelBuilder.Entity("WorkerBookingSystem.Models.AdminFundTransaction", b =>
                {
                    b.HasOne("WorkerBookingSystem.Models.ApplicationUser", "AdminUser")
                        .WithMany()
